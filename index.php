...
if(isset($_POST['btn-login'])){
    ...
    if(!$error){
        ...
        $sql = "select * from tbi_users where email='$email' ";
            ...
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                ...
                <div class="form-group">
                   <center><label for="email" class="control-label">Email</label></center>
                    <center><input type="email" name="<b>email</b>" class="form-control" autocomplete="off"></center>
                    <span class="text-danger"><?php if(isset($errorEmail)) echo $errorEmail; ?></span>
                </div>
                <div class="form-group">
                   <center><label for="password" class="control-label">Password</label></center>
                    <center><input type="password" name="password" class="form-control" autocomplete="off"></center>
